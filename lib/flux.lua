...
-- This library is used for its easing functions
-- You can, however, use it like normal if you'd like to avoid Tween objects
...
---@type {[EasingFunction]: fun(t: number): number}
